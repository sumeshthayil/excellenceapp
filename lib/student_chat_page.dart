...
class _StudentChatPageState extends State<StudentChatPage> {
  ...
  void _subscribeToMessages() {
    final filterId = supabase.auth.currentUser!.id;
    supabase
        .from('messages')
        .stream(primaryKey: ['id'])
        .eq('student_id', filterId)
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              ...
                              color: isStudent ? Colors.white : Colors.blue, // isAdmin for admin file
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Icon(
                          Icons.share,
                          size: 18,
                          color: isStudent ? Colors.white70 : Colors.blue, // isAdmin for admin file
                        ),
                      ),
                    ],
                  ),
